 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:k}=window,L=function(t,e){k.post(t).then((()=>window.location.assign(e)))},{$:E}=window;class x{extend(t){t.getContainer().on("click",m,(t=>{L(E(t.currentTarget).data("url"),E(t.currentTarget).data("redirect"))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:S}=window;class M{constructor(t){this.onClick=t}extend(t){this.initRowLinks(t),this.initConfirmableActions(t)}initConfirmableActions(t){t.getContainer().on("click",e.linkRowAction,(t=>{const e=S(t.currentTarget).data("confirm-message");e.length&&!window.confirm(e)&&t.preventDefault()}))}initRowLinks(t){const n=this.onClick;S("tr",t.getContainer()).each((function(){const t=S(this);S(e.linkRowActionClickableFirst,t).each((function(){const o=S(this),i=o.closest("td"),r=S(e.clickableTd,t).not(i);let s=!1;r.addClass("cursor-pointer").on("mousedown",(()=>{S(window).on("mousemove",(()=>{s=!0,S(window).off("mousemove")}))})),r.on("mouseup",(()=>{const t=s;if(s=!1,S(window).off("mousemove"),!t){const t=o.data("confirm-message");(!t.length||window.confirm(t)&&o.attr("href"))&&(A(n)||A(o.get(0))?document.location.href=o.attr("href"):n(o.get(0)))}}))}))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
