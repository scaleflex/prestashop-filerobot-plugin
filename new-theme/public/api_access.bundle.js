 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:_t}=window;_t((()=>{const t=new y("api_access");t.addExtension(new gt),t.addExtension(new k),t.addExtension(new O),t.addExtension(new B),t.addExtension(new pt),t.addExtension(new vt),t.addExtension(new yt)}))})(),window.api_access=o})();