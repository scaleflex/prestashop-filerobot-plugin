 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class B{extend(t){const e=t.getContainer().find(m);new E(e).attach()}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:A}=window,S=function(t,e){A.post(t).then((()=>window.location.assign(e)))},{$:M}=window;class L{extend(t){t.getContainer().on("click",g,(t=>{S(M(t.currentTarget).data("url"),M(t.currentTarget).data("redirect"))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Tt}=window;class Et{extend(t){t.getHeaderContainer().on("click",i.showQuery,(()=>this.onShowSqlQueryClick(t))),t.getHeaderContainer().on("click",i.exportQuery,(()=>this.onExportSqlManagerClick(t)))}onShowSqlQueryClick(t){const e=Tt(i.showModalForm(t.getId()));this.fillExportForm(e,t);const n=Tt(i.showModalGrid(t.getId()));n.modal("show"),n.on("click",x,(()=>e.submit()))}onExportSqlManagerClick(t){const e=Tt(i.showModalForm(t.getId()));this.fillExportForm(e,t),e.submit()}fillExportForm(t,e){const n=e.getContainer().find(s).data("query");t.find('textarea[name="sql"]').val(n),t.find('input[name="name"]').val(this.getNameFromBreadcrumb())}getNameFromBreadcrumb(){const t=Tt(b).find(p);let e="";return t.each(((t,n)=>{const o=Tt(n),i=o.find("a").length>0?o.find("a").text():o.text();e.length>0&&(e=e.concat(" > ")),e=e.concat(i)})),e}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class Bt{extend(t){const e=t.getContainer().find(v);e.find(w).prop("disabled",!0),e.find(D).on("input dp.change",(()=>{e.find(w).prop("disabled",!1),e.find(y).prop("hidden",!1)}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:zt}=window;zt((()=>{const t=new j("feature");t.addExtension(new Et),t.addExtension(new P),t.addExtension(new B),t.addExtension(new L),t.addExtension(new _t),t.addExtension(new xt),t.addExtension(new jt),t.addExtension(new Bt),t.addExtension(new St),t.addExtension(new It(t));new $t("featuresShowcaseCard").addExtension(new Lt)}))})(),window.feature=o})();