 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:E}=window,A=function(t,e){E.post(t).then((()=>window.location.assign(e)))},{$:O}=window;class B{extend(t){t.getContainer().on("click",b,(t=>{A(O(t.currentTarget).data("url"),O(t.currentTarget).data("redirect"))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Dt}=window;Dt((()=>{const t=new x("zone");t.addExtension(new B),t.addExtension(new j),t.addExtension(new M),t.addExtension(new L),t.addExtension(new P),t.addExtension(new R),t.addExtension(new At),t.addExtension(new Tt),t.addExtension(new Mt),t.addExtension(new $t),t.addExtension(new Ft),t.addExtension(new Bt),new Pt("#zone_shop_association").enableAutoCheckChildren()}))})(),window.zone=o})();