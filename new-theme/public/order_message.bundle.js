 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:jt}=window;jt((()=>{const t=new k("order_message");t.addExtension(new C),t.addExtension(new B),t.addExtension(new A),t.addExtension(new S),t.addExtension(new F),t.addExtension(new Ot),t.addExtension(new P),t.addExtension(new Et),t.addExtension(new Bt)}))})(),window.order_message=o})();