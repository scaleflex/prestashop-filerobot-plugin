 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:zt}=window;zt((()=>{const t=new C("meta");t.addExtension(new k),t.addExtension(new E),t.addExtension(new B),t.addExtension(new M),t.addExtension(new I),t.addExtension(new F),t.addExtension(new xt),t.addExtension(new jt),t.addExtension(new Lt),t.addExtension(new Rt);new St("seo-urls-showcase-card").addExtension(new Mt),new $t({tokenFieldSelector:"input.js-taggable-field",options:{createTokensOnBlur:!0}}),new Ft,new qt,window.prestashop.component.initComponents(["MultistoreConfigField"]),new Wt}))})(),window.meta=o})();