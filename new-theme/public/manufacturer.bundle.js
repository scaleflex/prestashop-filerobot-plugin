 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:$t}=window;$t((()=>{["manufacturer","manufacturer_address"].forEach((t=>{const e=new x(t);e.addExtension(new At),e.addExtension(new $),e.addExtension(new j),e.addExtension(new L),e.addExtension(new P),e.addExtension(new Et),e.addExtension(new xt),e.addExtension(new Tt),e.addExtension(new Mt),e.addExtension(new Lt)})),window.prestashop.component.initComponents(["TranslatableInput","TranslatableField","TinyMCEEditor"]),new window.prestashop.component.TaggableField({tokenFieldSelector:"input.js-taggable-field",options:{createTokensOnBlur:!0}}),new window.prestashop.component.ChoiceTree("#manufacturer_shop_association").enableAutoCheckChildren(),new i}))})(),window.manufacturer=o})();