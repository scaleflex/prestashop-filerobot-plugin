 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class A{extend(t){t.getHeaderContainer().on("click",f,(()=>{window.location.reload()}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:xt}=window;xt((()=>{const t=new w("address");t.addExtension(new k),t.addExtension(new B),t.addExtension(new O),t.addExtension(new A),t.addExtension(new M),t.addExtension(new wt),t.addExtension(new _t),t.addExtension(new kt),new Bt}))})(),window.address=o})();