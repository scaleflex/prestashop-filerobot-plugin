 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class S{extend(t){t.getHeaderContainer().on("click",x,(()=>{window.location.reload()}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:$t}=window;class Lt{extend(t){t.getHeaderContainer().on("click",d.gridSubmitAction,(e=>{this.handleSubmit(e,t)}))}handleSubmit(t,e){const n=$t(t.currentTarget),o=n.data("confirm-message");if(void 0!==o&&o.length>0&&!window.confirm(o))return;const i=$t(j(e.getId()));i.attr("action",n.data("url")),i.attr("method",n.data("method")),i.find(u.tokenInput(e.getId())).val(n.data("csrf")),i.submit()}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Dt}=window;Dt((()=>{const t=new M("email_logs");t.addExtension(new S),t.addExtension(new $),t.addExtension(new P),t.addExtension(new q),t.addExtension(new z),t.addExtension(new Mt),t.addExtension(new Tt),t.addExtension(new Lt),t.addExtension(new Ft),t.addExtension(new Pt),new e,new s,new l}))})(),window.email=o})();