 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class Bt{extend(t){const e=t.getContainer().find(g);e.find(v).prop("disabled",!0),e.find(y).on("input dp.change",(()=>{e.find(v).prop("disabled",!1),e.find(w).prop("hidden",!1)}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Et}=window;class At{constructor(t){this.id=t,this.$container=Et(`#${this.id}`)}getContainer(){return this.$container}addExtension(t){t.extend(this)}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:$t}=window;$t((()=>{const t=new x("attribute_group");t.addExtension(new jt),t.addExtension(new P),t.addExtension(new B),t.addExtension(new M),t.addExtension(new _t),t.addExtension(new Ot),t.addExtension(new xt),t.addExtension(new Bt),t.addExtension(new Lt(t));new At("attributesShowcaseCard").addExtension(new Mt)}))})(),window.attribute_group=o})();