 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class At{constructor(){const t=new v("contact");t.addExtension(new w),t.addExtension(new _),t.addExtension(new L),t.addExtension(new j),t.addExtension(new T),t.addExtension(new S),t.addExtension(new yt),t.addExtension(new Ct),t.addExtension(new xt),new Ot,new Bt("#contact_shop_association").enableAutoCheckChildren()}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
