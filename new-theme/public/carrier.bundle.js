 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$}=window,R=function(t,e){$.post(t).then((()=>window.location.assign(e)))},{$:I}=window;class z{extend(t){t.getContainer().on("click",C,(t=>{R(I(t.currentTarget).data("url"),I(t.currentTarget).data("redirect"))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class Rt{extend(t){const e=t.getContainer().find(_);e.find(k).prop("disabled",!0),e.find(O).on("input dp.change",(()=>{e.find(k).prop("disabled",!1),e.find(x).prop("hidden",!1)}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
