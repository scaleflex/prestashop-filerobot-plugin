 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Lt}=window;Lt((()=>{const t=new C("currency");t.addExtension(new E),t.addExtension(new mt),t.addExtension(new bt),t.addExtension(new wt),t.addExtension(new kt),t.addExtension(new Ct),t.addExtension(new Et),t.addExtension(new Ot),t.addExtension(new Tt),t.addExtension(new St),new At}))})(),window.currency=o})();