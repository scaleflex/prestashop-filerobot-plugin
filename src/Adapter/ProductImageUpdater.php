...
class ProductImageUpdater
{
    ...
    public function deleteImage(ImageId $imageId)
    {
        ...
        \Db::getInstance()->delete('image', 'id_image = ' . (int) $imageId->getValue());
        \Db::getInstance()->delete('image_lang', 'id_image = ' . (int) $imageId->getValue());
        \Db::getInstance()->delete('image_shop', 'id_image = ' . (int) $imageId->getValue());
        \Db::getInstance()->delete('product_attribute_image', 'id_image = ' . (int) $imageId->getValue());
